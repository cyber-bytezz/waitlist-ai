      ...
      <div className="max-w-3xl mx-8 md:mx-auto">
        <div className="my-20 space-y-10 text-center sm:my-16 md:space-y-14">
          <div className="space-y-5 md:space-y-8">
            <h1 className="text-4xl font-bold tracking-tight text-transparent bg-gradient-to-r from-white to-blue-300 bg-clip-text md:text-gray-900">
              Welcome to CoverIQ.
            </h1>
            <h2 className="text-lg text-gray-100 md:text-2xl md:mx-10 md:text-gray-600">
            "Automated cover letter generation tailored to job descriptions, empowering job seekers to stand out effortlessly."
            </h2>
          </div>
          <div className="transition duration-500 ease-in-out transform scale-100 translate-x-0 translate-y-0 opacity-100">
            <div className="space-y-2">
              ...
              Effortlessly create personalized cover letters in seconds with AI-powered automation for your job applications.
                <br />
